...
#     print(igtb_df.columns)
    ...
    sleep_stats_df = pd.read_csv(sleep_csv, index_col=0)
    ...
    fitbit_csv = base + path_to_fitbit + "stats.csv.gz"
    
    fitbit_df = pd.read_csv(fitbit_csv, index_col=7)
